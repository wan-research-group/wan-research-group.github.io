...
window.PEOPLE = {
  pi: {
    ...
    bio: [
      "Zishen Wan is an Assistant Professor of Computer Science at Columbia University, where he directs the Wan Lab. He is a computer architect and SoC designer working across computer architecture, computer systems, and VLSI design. His group develops cross-layer computing systems that span software system, hardware architecture, and silicon for emerging AI workloads, including embodied, physical, neuro-symbolic, and agentic AI. His group also develops agentic AI methods for the design, optimization, and verification of computing systems.",
