...
window.NEWS = [
  // ---------------- 2026 ----------------
  {
    date: "2026-08",
    tag: "Lab",
    text: "Zishen joins the [Department of Computer Science at Columbia University](https://www.cs.columbia.edu/) as an Assistant Professor, and the EMBARC Lab officially launches! We are recruiting PhD students (Fall 2027), postdocs, and student researchers. See [Join Us](join.html).",
  },
  {
    date: "2026-07",
    tag: "Award",
